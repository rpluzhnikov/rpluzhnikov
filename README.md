...
- **[Kensa IDE](https://kensa-ide.com)** - the desktop IDE for QA engineers. Test cases as Markdown in your own git repo, local-first, edited by your own terminal AI agent. Ships with a 30-command CLI built for agents, plus Blueprints for node-graph automation. Windows · macOS.
